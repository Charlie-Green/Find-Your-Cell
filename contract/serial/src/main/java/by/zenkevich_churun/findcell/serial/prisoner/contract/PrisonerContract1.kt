...
object PrisonerContract1 {
    ...
    const val CONTACT_TYPE_SKYPE     = 4.toShort()
    const val CONTACT_TYPE_VK        = 5.toShort()
    const val CONTACT_TYPE_FACEBOOK  = 6.toShort()
    const val CONTACT_TYPE_INSTAGRAM = 7.toShort()
    ...
    const val KEY_CONTACT_SKYPE      = "c${CONTACT_TYPE_SKYPE}"
